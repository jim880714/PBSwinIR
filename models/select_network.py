...
def define_G(opt):
    ...
    # ----------------------------------------
        ...
        from models.network_swinir_original import SwinIR as net
    ...
    # SwinIR_Modified
    # ----------------------------------------
    elif net_type == 'swinir_modified':
        from models.network_swinir import SwinIR_Modified as net
        print("opt_net:", opt_net)
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
