...
class ModelPlain(ModelBase):
    ...
    def optimize_parameters(self, current_step):
        ...
        # print(f"[Before forward] GPU allocated: {torch.cuda.memory_allocated() / 1024**3:.2f} GB")
        self.netG_forward()
        # print(f"[After forward] GPU allocated: {torch.cuda.memory_allocated() / 1024**3:.2f} GB")
